...
class Level:
    ...
    def create_map(self):
        layouts = {
            ...
            'entities': import_csv_layout('/Users/basedatlas/Desktop/SeniorProject/Senior-Project/map/map_Entities.csv')
        }
        graphics = {
...
class YSortCameraGroup(pygame.sprite.Group):
    def __init__(self):
        ...
        self.half_weight = self.display_surface.get_size()[1] // 2
        self.offset = pygame.math.Vector2()

        # creating the floor
        self.floor_surf = pygame.image.load('/Users/basedatlas/Desktop/SeniorProject/Senior-Project/graphics/tilemap/ground.png').convert()
    ...
    def custom_draw(self, player):
        ...
        self.offset.y = player.rect.centery - self.half_weight
